...
write.csv(df,"data/mysubmission1.txt", row.names = FALSE, quote=FALSE)
```

```{r}
pred <- read.csv("data/mysubmission1.txt")
...
write.csv(randomForest_df,"data/mysubmission2.txt", row.names = FALSE, quote=FALSE)

```

```{r}
pred <- read.csv("data/mysubmission2.txt")
names(test.y)[2] <- "True_Sale_Price"
pred <- merge(pred, test.y, by="PID")
sqrt(mean((log(pred$Sale_Price) - log(pred$True_Sale_Price))^2))
```
...
write.csv(ridge_df,"data/mysubmission3.txt", row.names = FALSE, quote=FALSE)

```

```{r}
pred <- read.csv("data/mysubmission3.txt")
names(test.y)[2] <- "True_Sale_Price"
pred <- merge(pred, test.y, by="PID")
sqrt(mean((log(pred$Sale_Price) - log(pred$True_Sale_Price))^2))
```
...
write.csv(lasso_df,"data/mysubmission4.txt", row.names = FALSE, quote=FALSE)

```

```{r}
pred <- read.csv("data/mysubmission4.txt")
names(test.y)[2] <- "True_Sale_Price"
pred <- merge(pred, test.y, by="PID")
sqrt(mean((log(pred$Sale_Price) - log(pred$True_Sale_Price))^2))
```
