...
# If there is a column in train.matrix that isnt in test.matrix created the column with all 0 values. 
# If there is a column in test.matrix that is not in train.matrix remove that column. 
